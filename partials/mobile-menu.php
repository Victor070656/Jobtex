                        ...
                        <nav class="main-nav mobile">
                            <ul id="menu-primary-menu" class="menu">
                                ...
                                <li class="menu-item menu-item-has-children-mobile">
                                    <a href="find-jobs-grid.html" class="iteam-menu">Find jobs
                                    </a>
                                </li>
                            </ul>
                        </nav>
                    ...
                    <div class="sub-categorie-mobile">
                        <ul class="pop-up">
                            <li class="categories-mobile">
                                <a href="#">
                                    <span class="icon-categorie-1"></span>Design & Creative
                                </a>
                            </li>
                            <li class="categories-mobile">
                                <a href="#">
                                    <span class="icon-categorie-8"></span>Digital Marketing
                                </a>
                            </li>
                            <li class="categories-mobile">
                                <a href="#">
                                    <span class="icon-categorie-2"></span>Development & IT
                                </a>
                            </li>
                            <li class="categories-mobile">
                                <a href="#">
                            ...
                            <li class="categories-mobile">
                                <a href="#">
                                    <span class="icon-categorie-4"></span>Finance & Accounting
                                </a>
                            </li>
                            <li class="categories-mobile">
                                <a href="#">
                                    <span class="icon-categorie-5"></span>Programming & Tech
                                </a>
                            </li>
                            <li class="categories-mobile">
                                <a href="#">
                                    <span class="icon-categorie-6"></span>Video & Animation
                                </a>
                            </li>
                            <li class="categories-mobile">
                                <a href="#">
